                ...
                {color.swatches.map(swatch => {
                    ...
                    return (
                        <button
                            ...
                            className={`relative group flex items-center justify-between p-3 rounded-grape text-left transition-transform duration-150 ease-in-out hover:scale-[1.02] active:scale-100 cursor-copy ${swatch.className}`}
                        >
