...
const FontSample: FunctionComponent<Props> = ({ name, variable, className }) => {
    ...
    return (
        <button
            ...
            <code className="absolute top-3 right-3 md:top-4 md:right-4 text-longan-500 dark:text-rambutan-400 bg-longan-200 dark:bg-longan-800 px-2 py-1 rounded-seed opacity-0 group-hover:opacity-100 transition-opacity">
                {variable}
            </code>
